...
################################################################
# This is a generated script based on design: bdAssessmentFramework
#
...
# source bdAssessmentFramework_script.tcl
...
set design_name bdAssessmentFramework
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_sysClk [get_bd_pins LMB_Clk] [get_bd_pins dlmb_bram_if_cntlr/LMB_Clk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins ilmb_bram_if_cntlr/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: ProcessingSystem
proc create_hier_cell_ProcessingSystem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_ProcessingSystem() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_sysClk [get_bd_pins Clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net reset_1 [get_bd_pins reset] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ML_Inference, and set properties
  set ML_Inference [ create_bd_cell -type ip -vlnv xilinx.com:hls:myproject:1.0 ML_Inference ]

  # Create instance: ProcessingSystem
  create_hier_cell_ProcessingSystem [current_bd_instance .] ProcessingSystem
  ...
  set_property -dict [ list \
   ...
   CONFIG.FIFO_IN_DEPTH {1} \
   CONFIG.FIFO_IN_DWIDTH {32} \
   CONFIG.FIFO_OUT_DEPTH {30} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ProcessingSystem_M01_AXI [get_bd_intf_pins ML_Inference/s_axi_control] [get_bd_intf_pins ProcessingSystem/M01_AXI]
  connect_bd_intf_net -intf_net ProcessingSystem_M02_AXI [get_bd_intf_pins ProcessingSystem/M02_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins ProcessingSystem/reset] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins ML_Inference/ap_rst_n] [get_bd_pins ProcessingSystem/S00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins comblock_0/axil_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ML_Inference/outputPrediction_TREADY] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ML_Inference/inputSignal_TLAST] [get_bd_pins xlconstant_0/dout]
